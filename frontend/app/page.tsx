...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white selection:bg-purple-600 selection:text-white">
      ...
      {/* ========================================================= */}
      <section className="relative overflow-hidden pt-16 pb-24 md:pt-28 md:pb-36 bg-black border-b border-white/[0.06]">
        {/* Ambient Purple Radial Glows (matches AssistAI template lighting) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          {/* Hero Headline (AssistAI Bold High-Contrast Sans Typography) */}
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-extrabold tracking-tight text-white max-w-4xl mx-auto leading-[1.08] text-balance">
          ...
          {/* ========================================================= */}
          {/* FLOATING DASHBOARD TEASER MOCKUP (Match Reference Image) */}
          {/* ========================================================= */}
          <div className="mt-16 sm:mt-24 max-w-5xl mx-auto rounded-2xl border border-white/10 bg-[#060608]/95 p-3.5 sm:p-5 shadow-2xl shadow-purple-950/25 backdrop-blur-2xl relative overflow-hidden text-left">
            {/* Ambient inner soft flare */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" />

            <div className="relative z-10 space-y-4">
              {/* Row 1: Mockup Top Bar (User pill, Nav tabs, Search, Icon) */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-white/[0.08]">
                ...
                {/* Centered App Navigation Tabs inside Dashboard */}
                <div className="hidden md:flex items-center gap-6 text-xs text-neutral-400 font-medium">
                  ...
                  <Link href="/interview" className="hover:text-white transition cursor-pointer">Interviews</Link>
                  <Link href="/roadmap" className="hover:text-white transition cursor-pointer">Roadmap</Link>
                  <Link href="/chat" className="hover:text-white transition cursor-pointer">AI Chat</Link>
                  <Link href="/profile" className="hover:text-white transition cursor-pointer">Profile</Link>
                </div>

                {/* Right Search Input & User Profile Icon */}
              ...
              {/* Row 2: Dashboard Header (Title, Date Range Pill, Download/Action Button) */}
              ...
              {/* Row 3: Sub-navigation Tabs (Overview, Analytics, Reports, Notifications) */}
              ...
              {/* Row 4: Mockup Content Metrics Grid */}
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
                {/* Metric 1 */}
                <div className="bg-[#0D0D12] border border-white/[0.07] p-3.5 rounded-xl">
                  <div className="text-[11px] font-medium text-neutral-400">Readiness Score</div>
                  <div className="text-xl font-bold text-white mt-1">86.4%</div>
                ...
                {/* Metric 2 */}
                <div className="bg-[#0D0D12] border border-white/[0.07] p-3.5 rounded-xl">
                  <div className="text-[11px] font-medium text-neutral-400">Mock Interviews</div>
                  <div className="text-xl font-bold text-white mt-1">12 / 15</div>
                ...
                {/* Metric 3 */}
                <div className="bg-[#0D0D12] border border-white/[0.07] p-3.5 rounded-xl">
                  <div className="text-[11px] font-medium text-neutral-400">DSA Questions</div>
                  <div className="text-xl font-bold text-white mt-1">148 Solved</div>
                ...
                {/* Metric 4 */}
                <div className="bg-[#0D0D12] border border-white/[0.07] p-3.5 rounded-xl">
                  <div className="text-[11px] font-medium text-neutral-400">Roadmap Sprint</div>
                  <div className="text-xl font-bold text-white mt-1">Day 22 / 60</div>
              ...
              {/* Row 5: Mockup Active Session & Telemetry Feed */}
      ...
      {/* ========================================================= */}
      <section id="features" className="py-24 bg-black relative border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card-elevated p-7 flex flex-col justify-between group">
              <div>
                ...
                <h3 className="text-lg font-bold text-white mb-2">1. AI Placement Chatbot</h3>
            ...
            <div className="card-elevated p-7 flex flex-col justify-between relative group border-purple-500/30">
              ...
              <div>
                ...
                <h3 className="text-lg font-bold text-white mb-2">2. AI Mock Interview</h3>
                <p className="text-neutral-400 text-xs sm:text-sm leading-relaxed mb-6">
            ...
            <div className="card-elevated p-7 flex flex-col justify-between group">
              <div>
                ...
                <h3 className="text-lg font-bold text-white mb-2">3. Personalized Roadmap</h3>
                <p className="text-neutral-400 text-xs sm:text-sm leading-relaxed mb-6">
      ...
      {/* ========================================================= */}
      <section className="py-24 bg-black relative border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="card-surface p-6 relative">
              <div className="text-3xl font-black text-purple-500/40 mb-3 font-mono">01</div>
              <h4 className="text-base font-bold text-white mb-2">Tell us your goal</h4>
            ...
            <div className="card-surface p-6 relative">
              <div className="text-3xl font-black text-purple-500/40 mb-3 font-mono">02</div>
              <h4 className="text-base font-bold text-white mb-2">Practice with AI</h4>
              <p className="text-xs text-neutral-400 leading-relaxed">
            ...
            <div className="card-surface p-6 relative">
              <div className="text-3xl font-black text-purple-500/40 mb-3 font-mono">03</div>
              <h4 className="text-base font-bold text-white mb-2">Follow your roadmap</h4>
              <p className="text-xs text-neutral-400 leading-relaxed">
            ...
            <div className="card-surface p-6 relative">
              <div className="text-3xl font-black text-purple-500/40 mb-3 font-mono">04</div>
              <h4 className="text-base font-bold text-white mb-2">Improve continuously</h4>
              <p className="text-xs text-neutral-400 leading-relaxed">
